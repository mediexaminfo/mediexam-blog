<header class="text-gray-600">
	<div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
		<a class="flex font-medium items-center text-gray-900 mb-2 md:mb-0" href="/">
			<svg
				xmlns="http://www.w3.org/2000/svg"
				fill="currentColor"
				class="w-10 h-10 text-white p-2 bg-primary-500 rounded-full"
        viewBox="0 0 15 15"
			>
				<path
			...
			<span class="ml-3 text-xl">MediEXAM Doctor</span>
		</a>
		<nav
			class="md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-gray-400	flex flex-wrap items-center text-base justify-center space-x-5"
		>
			<a class="hover:text-gray-900" href="/blog">Blog</a>
			<a class="hover:text-gray-900" href="/exams">Exams</a>
